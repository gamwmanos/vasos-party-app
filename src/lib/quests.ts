...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: 'Ανέβασε στην πλάτη σου έναν άνθρωπο που ΔΕΝ ΞΕΡΕΙΣ ΚΑΙ ΕΙΝΑΙ ΑΝΤΙΘΕΤΟΥ ΦΥΛΟΥ — σαν αλογάκι! Πρέπει να είναι σωστό piggyback (πλήρως πάνω στην πλάτη, όχι στη μέση!)',
    points: 1
  },
  {
    id: 'q12',
