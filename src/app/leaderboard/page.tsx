  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-dark)] p-4">
      <header className="flex items-center gap-4 py-4 mb-6">
        ...
        <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan to-neon-pink text-glow-cyan">
          Leaderboard
        </h2>
      </header>
          ...
          {leaders.map((leader, index) => (
            ...
            >
              ...
              <div className="z-10 flex flex-col items-end">
                <span className="text-3xl font-black text-neon-cyan text-glow-cyan">{leader.score}</span>
