              ...
              <form onSubmit={handleJoin} className="space-y-6">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-400 text-center px-2">
                    {formMode === "register" 
                      ? "Βάλε μόνο το μικρό σου όνομα και ένα κρυφό PIN για να μην μπει άλλος στον λογαριασμό σου! (Μη βάλεις basic κωδικό τύπου 1234 γιατί μπορεί να γίνει μαλακία)" 
                      : "Αν έχεις ξαναμπεί, χρησιμοποίησε ακριβώς το ίδιο Όνομα και PIN για να μη χάσεις τους πόντους σου! (Προτείνουμε να βάλεις μόνο το μικρό σου όνομα)"}
                  </p>
                </div>
